reporteexcel.blade.php<!DOCTYPE html>
<html lang="es">
<head>
	<meta charset="utf-8">
...
<div>
    <header>           
        <center><table BORDER=1 WIDTH=100% class="table table-striped table-bordered">
                <thead>
                  <tr>
                  ...
                  <tr>
                  	<th>&nbsp;&nbsp;</th>
                    <th colspan="5" align="center"> Sistema Evaluación de Desempeño del Personal(SEDP)</th>
                  </tr>
                </thead>
                <tbody>
                </tbody>
