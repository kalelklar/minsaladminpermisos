                ...
                <div class="row">
                  <div class="span12">
                    ...
                    <div class="widget-content">
                      ...
                      <h1>Reporte Estadístico de Horas</h1>
                      <h6 class="bigstats">Es un reporte que se genera apartir de los datos registrados en el Sistema fichas de Empleados que nos permite ver que tema recibio menor y mayor cantidad de horas por componente</h6>
          ...
          <div class="widget-content">
            ...
            <br>
              ...
              <div class="tab-content">
                ...
                {{ Form::open(array('action' => 'reporte5Controller@show')) }}
                  <fieldset>
