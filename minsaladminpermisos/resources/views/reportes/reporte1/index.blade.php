                ...
                <div class="row">
                  <div class="span12">
                    ...
                    <div class="widget-content">
                      ...
                      <h1>Reporte de Temas Clasificados por Componente</h1>
                      <h6 class="bigstats">Es un reporte que se genera apartir de los datos registrados en el Sistema fichas de Empleados que nos permite ver los diferentes temas clasifica por componente en un periodo</h6> 
          ...
          <div class="widget-content">
            ...
            <br>
              ...
              <div class="tab-content">
                ...
                {{ Form::open(array('action' => 'reporte1Controller@show')) }}
                  <fieldset>
