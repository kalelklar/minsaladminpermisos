...
<html>
<head>
  <title>Reporte de Ingreso de Solicitud para la consecion del permiso Sanitario</title>
                      ...
                      <div class="widget big-stats-container">
                        <div class="widget-content">
                          <div id="big_stats" class="cf">
                            ...
                            <div class="stat"><a href="{{URL::action('SolicitudController@reportepdf',[$idsolicitud])}}"><i class="icon-large icon-file
